...
return(
    ...
    <div className="bg-success p-2 text-white bg-opacity-75">Update Nutrition Plans</div>
        ...
        <div className="form-group">
          ...
          <input name="id" type = "number" className="form-control" id="id" required value={formik.values.id} onChange={formik.handleChange} placeholder="Enter the Id"/>
          {formik.errors.id? <div className="errors">{formik.errors.id}</div> : null}
          </div>

          <div className="form-group">
            <label htmlFor="planDescription">name:</label>
            <input name="name" className="form-control" type="text" id="name" required value={formik.values.name} onChange={formik.handleChange} placeholder="Enter the name" />
            {formik.errors.name? <div className="errors">{formik.errors.name}</div> : null}
          </div>
          
          <div className="form-group">
            <label htmlFor="planDescription">planDescription</label>
            <input name="planDescription" className="form-control"  type="text" id="planDescription" required  value={formik.values.planDescription} onChange={formik.handleChange} placeholder="Enter the Plan Description"/>
        ...
        <div className="form-group">
            ...
            <input name="created_At" className="form-control"  type="date" id="created_At" required  value={formik.values.created_At} onChange={formik.handleChange} placeholder="Enter the protein Ratio"/>
            {formik.errors.created_At? <div className="errors">{formik.errors.created_At}</div> : null}
            </div>
         <div className="form-group">
            <label htmlFor="updated_At">updated_At</label>
            <input name="updated_At" className="form-control"  type="date" id="updated_At" required  value={formik.values.updated_At} onChange={formik.handleChange} placeholder="Enter the fat Ratio"/>
        ...
        <div className="form-group">
            ...
            <input name="price" className="form-control"  type="number" id="price" required  value={formik.values.price} onChange={formik.handleChange} placeholder="Enter the price"/>
